...
class HomeLibrary:
    def __init__(self):
        ...
        self.add_book("Війна і мир", "Лев Толстой", 1869, "Роман")
...
def display_menu():
    ...
    print("7. Переглянути всі матеріали")
    print("8. Пошук матеріалу")
    print("9. Сортувати матеріали")
    print("10. Показати книги")
    print("11. Показати статті")
    print("12. Показати журнали")
    print("13. Вийти")

# Action functions for handling choices
